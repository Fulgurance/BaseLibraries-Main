class Target < ISM::Software
    ...
    def prepareInstallation
        ...
        extractArchive("#{buildDirectoryPath(false)}/dist/Pygments-2.16.1.linux-x86_64.tar.gz")
        ...
        pythonData = <<-CODE
        pathappend /usr/lib/python3.11/site-packages/Pygments-2.16.1-py3.11.egg PYTHONPATH
        CODE
