class Target < ISM::Software
    ...
    def configure
        ...
        configureSource([   "--prefix=#{builtSoftwareDirectoryPath(false)}#{Ism.settings.rootPath}usr",
                            ...
                            "--importdir=#{builtSoftwareDirectoryPath(false)}#{Ism.settings.rootPath}usr/lib/qt5/imports",
                            "--headerdir=#{builtSoftwareDirectoryPath(false)}#{Ism.settings.rootPath}usr/include/qt5",
