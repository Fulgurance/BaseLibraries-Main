class Target < ISM::Software
    ...
    def prepareInstallation
        ...
        extractArchive("#{buildDirectoryPath(false)}/dist/Mako-1.2.4.linux-x86_64.tar.gz")
        ...
        pythonData = <<-CODE
        pathappend /usr/lib/python3.11/site-packages/Mako-1.2.4-py3.11.egg PYTHONPATH
        CODE
