class Target < ISM::Software
    ...
    def prepareInstallation
        ...
        runTarCommand(  arguments:  "-xf pyqt6-webengine-6.7.0.linux-x86_64.tar.gz",
        ...
        pythonData = <<-CODE
        pathappend /usr/lib/python3.11/site-packages/pyqt6-webengine-6.7.0-py3.11-linux-x86_64.egg PYTHONPATH
        CODE
